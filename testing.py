...
g1 = np.array(g1)
g2 = np.array(g2)
rho, theta, u = mySE3.decompose_cartesian_element(delta)
my_start_time = time.time()
my_comp = mySE3.group_composition(g1, g2)
my_inv = mySE3.group_inverse(g1)
my_adjoint = mySE3.adjoint(g1)
my_right_plus = mySE3.plus_right(g1, rho, theta, u)
rho_minus_right, theta_minus_right, u_minus_right = mySE3.minus_right(g1, g2)
my_right_minus = mySE3.compose_cartesian_element(rho_minus_right, theta_minus_right, u_minus_right)
my_left_plus = mySE3.plus_left(g1, rho, theta, u)
rho_minus_left, theta_minus_left, u_minus_left = mySE3.minus_left(g1, g2)
my_left_minus = mySE3.compose_cartesian_element(rho_minus_left, theta_minus_left, u_minus_left)
